  ...
  return (
    <div className="twoColumns">
      ...
      <div className="right">
        ...
        a girls who code summer camp at rit, and participated in a local k-12 female hackathon, rocgirlhacks. both of these events were held with 
        support from the women in computing organization of rit, which i am a part of today!
        <br></br><br></br>
        ...
        i am a part of wic's wichacks commitee - the team responsible for organizing our annual women, femme, and nonbinary 24-hour hackathon.
        <br></br><br></br>
        excited to gain industry experience as i go through more internships, co-ops, and other exciting learning opportunities!
        <br></br><br></br>
